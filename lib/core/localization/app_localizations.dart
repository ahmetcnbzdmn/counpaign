  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'tr': {
      ...
      // Auth & Profile
       ...
       'optional_label': 'İsteğe bağlı',
      'birth_date_note': '* İsteğe bağlı. Kayıt olduktan sonra doğum tarihini değiştiremezsiniz.',
       'forgot_password': 'Parolamı Unuttum?',
       'login_btn': 'Giriş Yap',
       'register_btn': 'Kayıt Ol',
       'create_account_btn': 'Yeni Hesap Oluştur',
       'continue_as_guest': 'Üyeliksiz Devam Et',
       'no_account': 'Hesabın yok mu? Kayıt Ol',
       'already_member': 'Zaten üye misin? Giriş Yap',
       'intro_title_1': 'Kahve Keyfini Katla!',
       'intro_desc_1': 'Her kahvende yeni bir ödül kazan, cüzdanını sevdiğin dükkanlarla doldur.',
       'intro_title_2': 'Hızlı ve Kolay!',
       'intro_desc_2': 'QR kodu okut, saniyeler içinde puanlarını topla ve harca.',
       'intro_title_3': 'Özel Fırsatlar!',
       'intro_desc_3': 'Sadece sana özel kampanyaları keşfet, hiçbir fırsatı kaçırma.',
       ...
       'pwd_strength_label': 'Şifre gücü',
       'pwd_strength_empty': '—',
       'pwd_strength_weak': 'Çok zayıf',
       'pwd_strength_fair': 'Orta',
       'pwd_strength_good': 'İyi',
       'pwd_strength_strong': 'Güçlü',
       'pwd_req_length': '8+ karakter',
       'pwd_req_upper': 'Büyük harf',
       'pwd_req_number': 'Rakam',
       'pwd_req_symbol': 'Özel karakter',
       'pwd_requirements_not_met': 'Şifre tüm şartları sağlamalıdır: 8+ karakter, büyük harf, rakam ve özel karakter.',
      ...
      'notification_default_title': 'Bildirim',
      'swipe_delete': 'Sil',
      'swipe_mark_read': 'Okundu İşaretle',
      'status_read': 'Okundu',
      'guest_qr_remaining': 'QR hakkınız kaldı',
      'guest_qr_all_used': 'Tüm haklarınızı kullandınız — kayıt olun!',
      'register_guest_btn': 'Kayıt Ol',
      ...
      'scan_in_progress_error': 'Şu an başka bir işlem devam ediyor. Lütfen birkaç saniye bekleyip tekrar deneyin.',
      ...
      'account_deleted_notice': 'Bu hesap artık kullanılamıyor. Lütfen yeni bir hesap oluşturun.',
    ...
    'en': {
      ...
      'scan_in_progress_error': 'Another transaction is in progress. Please wait a few seconds and try again.',
      ...
      'account_deleted_notice': 'This account is no longer available. Please create a new account.',
      ...
      'birth_date_note': '* Optional. You cannot change your birth date after registration.',
      ...
      'intro_title_1': 'Multiply Your Coffee Joy!',
      'intro_desc_1': 'Earn rewards with every coffee, fill your wallet with your favorite shops.',
      'intro_title_2': 'Fast and Easy!',
      'intro_desc_2': 'Scan a QR code, collect and spend your points in seconds.',
      'intro_title_3': 'Exclusive Deals!',
      'intro_desc_3': 'Discover campaigns just for you, never miss an opportunity.',
      ...
      'pwd_strength_empty': '—',
      'pwd_strength_weak': 'Very weak',
      'pwd_strength_fair': 'Fair',
      'pwd_strength_good': 'Good',
      'pwd_strength_strong': 'Strong',
      'pwd_req_length': '8+ chars',
      'pwd_req_upper': 'Uppercase',
      'pwd_req_number': 'Number',
      'pwd_req_symbol': 'Symbol',
      'pwd_requirements_not_met': 'Password must meet all requirements: 8+ chars, uppercase, number and symbol.',
      ...
      'swipe_delete': 'Delete',
      'swipe_mark_read': 'Mark as Read',
      'status_read': 'Read',
      'guest_qr_remaining': 'QR scans remaining',
      'guest_qr_all_used': 'All free scans used — register!',
      'register_guest_btn': 'Register',
